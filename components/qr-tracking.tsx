...
const mockQRCodes: QRCode[] = [
  {
    ...
    type: "checkin",
    description: "Primary check-in point for conference attendees",
  ...
  },
  {
    ...
    type: "session",
    description: "Entry QR for the main keynote presentation",
  ...
  },
  {
    ...
    type: "networking",
    description: "Access to networking area and contact exchange",
...
const mockRecentScans: QRScan[] = [
  ...
  },
  {
    ...
    userId: "user2",
    userName: "Mike Chen",
    userEmail: "mike.chen@designstudio.com",
  ...
  },
  {
    ...
    userId: "user3",
    userName: "Emma Davis",
    userEmail: "emma.davis@startup.io",
